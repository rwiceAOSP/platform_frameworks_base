...
public class HealthService extends Service {
    ...
    private final IHealthService.Stub mBinder = new IHealthService.Stub() {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags)
            ...
            // Stock leaves transacts 9 and 10 as no-op stubs (no caller enforcement).
            if (code == 9) {
                data.readBoolean();
            ...
            // Transacts 1..8 dispatch to the AIDL-generated handlers, each of which
            // internally enforces the supported-caller whitelist.
    ...
    public IBinder onBind(Intent intent) {
        ...
        return mHealthFeatureEnabled ? mBinder : new Binder();
    }
}
