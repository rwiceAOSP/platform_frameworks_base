...
public final class PulsarController {
    ...
    private void showPulsarEnabledNotification() {
        try {
            ...
            NotificationCompat.Builder builder = new NotificationCompat.Builder(mContext, "BAT")
                    .setSmallIcon(R.drawable.ic_power_low) // stock uses 0x7f080851 (~ battery)
            ...
            int id = R.string.pulsar_enabled_notification_title; // stock uses resource id as notification id
            mNotificationManager.notifyAsUser("pulsar_enabled", id, n, UserHandle.CURRENT);
            if (mUiEventLogger != null) {
    ...
    private void showPulsarReminderNotification() {
        try {
            ...
            PowerUtils.overrideNotificationAppName(mContext, builder);
            Notification n = builder.build();
            int id = R.string.pulsar_reminder_notification_title;
            mNotificationManager.notifyAsUser("pulsar_reminder", id, n, UserHandle.CURRENT);
            if (mUiEventLogger != null) {
